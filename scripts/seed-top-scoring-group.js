...
// Seed the "Gruppen med flest mål" market with 12 outcomes (Gruppe A–L).
// Odds are fixed at 5.00 since there is no live odds source for this market.
//
// Run: SUPABASE_URL=… SUPABASE_SERVICE_ROLE_KEY=… node scripts/seed-top-scoring-group.js
...
async function main() {
  ...
  const { data: market, error: marketErr } = await supabase
    ...
    .insert({
      key: 'top_scoring_group',
      title: 'Gruppen med flest mål',
      status: 'open',
